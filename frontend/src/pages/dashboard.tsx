...
const Dashboard = () => {
  ...
  const [alerts, setAlerts] = React.useState('Loading...');
  const [corporate_sponsors, setCorporate_sponsors] =
    React.useState('Loading...');
  const [educational_contents, setEducational_contents] =
    React.useState('Loading...');
  const [regions, setRegions] = React.useState('Loading...');
  const [restoration_projects, setRestoration_projects] =
    React.useState('Loading...');
  ...
  async function loadData() {
    ...
    const fns = [
      setUsers,
      setAlerts,
      setCorporate_sponsors,
      setEducational_contents,
      setRegions,
      setRestoration_projects,
      setRoles,
      setPermissions,
      setOrganizations,
    ];
    ...
    <>
      ...
      <SectionMain>
        ...
        <div className='grid grid-cols-1 gap-6 lg:grid-cols-3 mb-6'>
          ...
          {hasPermission(currentUser, 'READ_CORPORATE_SPONSORS') && (
            <Link href={'/corporate_sponsors/corporate_sponsors-list'}>
              <div className='rounded dark:bg-gray-900/70 bg-white border border-pavitra-400 p-6'>
                <div className='flex justify-between align-center'>
                  <div>
                    <div className='text-lg leading-tight text-gray-500 dark:text-gray-400'>
          ...
          {hasPermission(currentUser, 'READ_EDUCATIONAL_CONTENTS') && (
            <Link href={'/educational_contents/educational_contents-list'}>
              <div className='rounded dark:bg-gray-900/70 bg-white border border-pavitra-400 p-6'>
                <div className='flex justify-between align-center'>
                  <div>
                    <div className='text-lg leading-tight text-gray-500 dark:text-gray-400'>
          ...
          {hasPermission(currentUser, 'READ_REGIONS') && (
            <Link href={'/regions/regions-list'}>
              <div className='rounded dark:bg-gray-900/70 bg-white border border-pavitra-400 p-6'>
                <div className='flex justify-between align-center'>
                  <div>
                    <div className='text-lg leading-tight text-gray-500 dark:text-gray-400'>
          ...
          {hasPermission(currentUser, 'READ_RESTORATION_PROJECTS') && (
            <Link href={'/restoration_projects/restoration_projects-list'}>
              <div className='rounded dark:bg-gray-900/70 bg-white border border-pavitra-400 p-6'>
                <div className='flex justify-between align-center'>
                  <div>
                    <div className='text-lg leading-tight text-gray-500 dark:text-gray-400'>
