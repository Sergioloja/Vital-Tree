...
module.exports = class OrganizationsDBApi {
  ...
  static async findBy(where, options) {
    ...
    output.alerts_organization = await organizations.getAlerts_organization({
      transaction,
    });

    output.corporate_sponsors_organization =
      await organizations.getCorporate_sponsors_organization({
        transaction,
      });

    output.educational_contents_organization =
      await organizations.getEducational_contents_organization({
        transaction,
      });

    output.regions_organization = await organizations.getRegions_organization({
      transaction,
    });

    output.restoration_projects_organization =
      await organizations.getRestoration_projects_organization({
        transaction,
      });
